...
librosRoutes.get("/:id", [isAuth] , getLibrosById)        //le meto el [isAuth] para controlar que solo los autorizados puedan ver libros por id
...
librosRoutes.delete("/:idLibro", [isAuth] , deleteLibro)        //le meto el [isAuth] para controlar que solo los autorizados puedan eliminar libros
//declaro la ruta para que use el controlador que elimina libros por título
librosRoutes.delete("/deleteByTitle/:titleLibro", deleteLibroByTitle)
//declaro la ruta para que use el controlador que actualizará el libro
librosRoutes.put("/:idLibro", updateLibro)
